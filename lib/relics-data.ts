export interface RelicItem {
  ...
  valuationBRL: number;
  valuationUSD: number;
  status: 'active_bid' | 'direct_buy' | 'private_treaty';
  statusLabel: string;
...
export const CATALOG_RELICS: RelicItem[] = [
  {
    id: 'pel-1970',
    lotNumber: 'LOT #1970-MEX-10',
    title: 'Manto Final Copa 1970 Autografado por Pelé',
    athlete: 'Pelé (Edson Arantes)',
    sport: 'futebol',
    category: 'Copa do Mundo 1970 • México',
    description: 'Camisa canarinho usada no Estádio Azteca com vestígios biológicos de jogo e assinatura atestada por perícia caligráfica.',
    year: 1970,
    grade: 'Grau COA 9.8 Archival',
    valuationBRL: 4850000,
    valuationUSD: 970000,
    status: 'active_bid',
    statusLabel: 'Lance Ativo • 04D 18H',
    timeRemaining: '04D 18H',
    custodian: 'Geneva Freeport',
    custodianFacility: 'Bóveda de Alta Segurança #G-44',
    insurancePolicy: 'LL-BR70-98402 (Lloyd\'s London)',
    sha256Hash: 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
    imageUrl: RELIC_IMAGES.pele1970Catalog,
    altText: 'Museum showcase photograph of Pele 1970 Brazil World Cup authentic final match worn yellow jersey with number 10',
    verifiedMethod: 'Espectrometria 8K & C14',
  },
  {
    id: 'sen-1991',
    lotNumber: 'LOT #F1-SENNA-91',
    title: 'Capacete Bell GP3 McLaren 1991 Ayrton Senna',
    athlete: 'Ayrton Senna',
    sport: 'f1',
    category: 'Fórmula 1 • McLaren Honda',
    description: 'Exemplar utilizado durante o GP de Interlagos 1991. Pintura original Sid Special Paint com rádio de bordo intacto.',
    year: 1991,
    grade: 'Grau COA 9.9 Gem Mint',
    valuationBRL: 2450000,
    valuationUSD: 490000,
    status: 'direct_buy',
    statusLabel: 'Compra Direta em Escrow',
    custodian: 'Vault São Paulo',
    custodianFacility: 'Bandeirantes Safe Facility',
    insurancePolicy: 'LL-SEN-9104 (Lloyd\'s London)',
    sha256Hash: '4f81c9a0912dfbc78e019a823dcbe9102948bcda819273461028394012bc0a19',
    imageUrl: RELIC_IMAGES.senna1991Helmet,
    altText: 'Historic Formula 1 racing helmet of Ayrton Senna from 1991 McLaren season in vibrant yellow green and blue stripes',
    verifiedMethod: 'FIA Heritage & Sid Special Registry',
  },
  {
    id: 'jor-1998',
    lotNumber: 'LOT #NBA-LASTDANCE-23',
    title: 'Regata Game 2 NBA Finals 1998 Michael Jordan',
    athlete: 'Michael Jordan',
    sport: 'basquete',
    category: 'NBA Finals 1998 • Last Dance',
    description: 'Regata vermelha Chicago Bulls número 23. Laudo de correspondência fotográfica de trama têxtil e desgaste de costura.',
    year: 1998,
    grade: 'Grau COA 9.7 Archival',
    valuationBRL: 5900000,
    valuationUSD: 1180000,
    status: 'active_bid',
    statusLabel: 'Lance Ativo • 02D 06H',
    timeRemaining: '02D 06H',
    custodian: 'Brink\'s Escort em Trânsito',
    custodianFacility: 'Rota Segura: JFK ➔ GRU 09:40',
    insurancePolicy: 'LL-JOR-9823 (Lloyd\'s London)',
    sha256Hash: '9a8b7c6d5e4f3a2b1c0d9e8f7a6b5c4d3e2f1a0b9c8d7e6f5a4b3c2d1e0f9a8b',
    imageUrl: RELIC_IMAGES.jordan1998Jersey,
    altText: 'Michael Jordan red Chicago Bulls game worn jersey from 1998 NBA Finals The Last Dance',
    verifiedMethod: 'MeiGray Photo-Match & NBA Auth',
  },
  {
    id: 'ali-1971',
    lotNumber: 'LOT #BOX-ALI-1971',
    title: 'Luvas da \'Luta do Século\' 1971 Muhammad Ali',
    athlete: 'Muhammad Ali',
    sport: 'boxe',
    category: 'Boxe • MSG Nova York 1971',
    description: 'Par de luvas de couro Everlast original com lacre de época de Angelo Dundee e certificação fiduciária da família Ali.',
    year: 1971,
    grade: 'Grau COA 9.6 Archival',
    valuationBRL: 3100000,
    valuationUSD: 620000,
    status: 'private_treaty',
    statusLabel: 'Tratado Privado',
    custodian: 'Geneva Freeport',
    custodianFacility: 'Vault Bóveda #G-12',
    insurancePolicy: 'LL-ALI-7108 (Lloyd\'s London)',
    sha256Hash: '1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b',
    imageUrl: RELIC_IMAGES.ali1971Gloves,
    altText: 'Vintage Everlast leather boxing gloves worn by Muhammad Ali in 1971 Fight of the Century',
    verifiedMethod: 'C14 Carbon Dated & Dundee Seal',
  },
  {
    id: 'pel-boot-1970',
    lotNumber: 'LOT #FOOT-PELE-70K',
    title: 'Chuteira Puma King México 1970 Edson Arantes',
    athlete: 'Pelé (Edson Arantes)',
    sport: 'futebol',
    category: 'Copa do Mundo 1970 • Puma Archives',
    description: 'Pé direito confeccionado sob medida na Alemanha com travas moldadas e inscrição interna de autenticidade do Rei.',
    year: 1970,
    grade: 'Grau COA 9.8 Archival',
    ...
    status: 'direct_buy',
    statusLabel: 'Compra Direta em Escrow',
    custodian: 'Zurique FreeVault',
    custodianFacility: 'Câmara Criptográfica #Z-09',
    insurancePolicy: 'LL-PUM-7099 (Lloyd\'s London)',
    sha256Hash: '2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d',
    imageUrl: RELIC_IMAGES.pele1970Boot,
    altText: 'Original 1970 vintage Puma King black leather football boot worn by soccer legend Pele',
    verifiedMethod: 'Micro-UV Certified & Puma Ledger',
  },
  {
    id: 'sen-trophy-1993',
    lotNumber: 'LOT #F1-TR-1993',
    title: 'Troféu Histórico Construtores F1 Interlagos 1993',
    athlete: 'Ayrton Senna',
    sport: 'f1',
    category: 'Fórmula 1 • GP Brasil 1993',
    description: 'Troféu original esculpido em prata de lei e banho em ouro 24k concedido na memorável vitória de Ayrton Senna sob tempestade.',
    year: 1993,
    grade: 'Grau COA 9.9 Museum Piece',
    valuationBRL: 4200000,
    valuationUSD: 840000,
    status: 'active_bid',
    statusLabel: 'Lance Ativo • 01D 11H',
    timeRemaining: '01D 11H',
    custodian: 'Vault São Paulo',
    custodianFacility: 'Cofre Diamante #SP-01',
    insurancePolicy: 'LL-F1-9311 (Lloyd\'s London)',
    sha256Hash: '3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e',
    imageUrl: RELIC_IMAGES.f11993Trophy,
    altText: 'Gold and sterling silver 1993 Formula 1 Brazilian Grand Prix constructors trophy',
    verifiedMethod: 'FIA Heritage Registry & Metalurgic Test',
  },
];
